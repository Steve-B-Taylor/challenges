...
Open up the terminal (iTerm on OSX or Gitbash on Windows) and use the following instructions to get started.
**Be sure you're always working from your challenges folder before downloading!**
