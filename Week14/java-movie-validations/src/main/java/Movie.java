...
public class Movie {
  ...
  @NotNull(message="Can not be null")
  @Min(value = 1920, message="year is greater than or equal to 1920")
  ...
  @Min(value = 0, message="rating must be equal to or higher than 0")
  @Max(value = 100, message="rating must be equal to or lower than 100")
  @Column(name="rating")
